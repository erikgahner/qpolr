...
As you can see, the background is dark in the RStudio environment in Figure \@ref(fig:interfaceexplain). If you want to change the colours of your RStudio environment, go to Tools $\rightarrow$ `Global Options...` $\rightarrow$ `Appearance`.

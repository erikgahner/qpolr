...
We will use the dataset we created in the previous chapter. If you do not have it, you can download it here (make sure to have the data file saved in your working directory): [http://qpolr.com/data/uk2017.csv](http://qpolr.com/data/uk2017.csv)

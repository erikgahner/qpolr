...
% Everything below added by CII
  ...
  \end{Highlighting}
  \end{Shaded}
  \begin{center}\includegraphics{qpolr_files/figure-latex/unnamed-chunk-134-1} \end{center}
  ...
  \end{Highlighting}
  \end{Shaded}
  \begin{center}\includegraphics{qpolr_files/figure-latex/unnamed-chunk-135-1} \end{center}
